...
function onEvent(name, value1, value2)
	if name == 'Fade UI' then
		...
		if type == 1 and duration == 0 then
            ...
            setProperty('opponentIconsquare',  tonumber(0))
            setProperty('boyIconsquare',  tonumber(0))
            ...
            setProperty('time.alpha', tonumber(0))
		...
		elseif type == 1 and duration > 0 then
            ...
            doTweenAlpha('opponentIconsquare', 'opponentIconsquare', 0, duration, 'quartInOut')
            doTweenAlpha('boyIconsquare', 'boyIconsquare', 0, duration, 'quartInOut')
            ...
            doTweenAlpha('time', 'time', 0, duration, 'quartInOut')
		...
		if type == 0 and duration == 0 then
            ...
            setProperty('opponentIconsquare',  tonumber(1))
            setProperty('boyIconsquare',  tonumber(1))
            setProperty('iconP1.alpha',  tonumber(1))
            setProperty('iconP2.alpha',  tonumber(1))
            setProperty('scoreTxt.alpha',  tonumber(1))
            setProperty('time.alpha', tonumber(1))
		...
		elseif type == 0 and duration > 0 then
            ...
            doTweenAlpha('opponentIconsquare', 'opponentIconsquare', 1, duration, 'quartInOut')
            doTweenAlpha('boyIconsquare', 'boyIconsquare', 1, duration, 'quartInOut')
            ...
            doTweenAlpha('time', 'time', 1, duration, 'quartInOut')
