function onCreatePost()
	if shadersEnabled == true then
        ...
        for i, object in ipairs({'boyfriend', 'dad', 'gf'}) do
    		...
    		setShaderFloat(object, 'hue', -25)
    		setShaderFloat(object, 'saturation', 5)
			...
			setShaderFloatArray(object, 'dropColor', {221 / 255, 0 / 255, 0 / 255})
			...
			if object == 'dad' then
				setShaderFloat(object, 'ang', math.rad(80))
				setShaderFloat(object, 'dist', 18)
			end
		end
	end
end
