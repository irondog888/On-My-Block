...
local nameprefix = "craigsepetateo" -- the beginning of the filename for all voiceclips put in the sounds folder
local maxvoicelines = 1 -- set this to how many voicelines you are using (this will identify the number at the end of each sound file)
