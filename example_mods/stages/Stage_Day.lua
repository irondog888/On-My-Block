function onCreate()
	makeLuaSprite('bg','stageAssets/stageDay/a',-750,-160)
	makeLuaSprite('truss','stageAssets/stageDay/coso',-750,-160)
	makeLuaSprite('stage','stageAssets/stageDay/esenario',-750,-160)
	makeLuaSprite('lights','stageAssets/stageDay/linternaxd',-750,-160)
	makeAnimatedLuaSprite('crowd','stageAssets/stageDay/fools',-750,-160)
	addAnimationByPrefix('crowd','bop','Upper Crowd Bob',12,false)
	makeAnimatedLuaSprite('logo','stageAssets/stageDay/logo',450,20)
