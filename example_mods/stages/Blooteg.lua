function onCreate()
	makeLuaSprite('bg','stageAssets/blooteg/back',-550,-300)
	makeLuaSprite('stage','stageAssets/blooteg/mesa',-550,-300)
	makeLuaSprite('gorl','stageAssets/blooteg/azucar',-250,0)
	makeLuaSprite('nut','stageAssets/blooteg/nut',650,400)
	makeAnimatedLuaSprite('silly','stageAssets/blooteg/Fumos',850,250)
	addAnimationByPrefix('silly','bop','dance',24,false)
	makeAnimatedLuaSprite('pepino','stageAssets/blooteg/Pepino',250,100)
